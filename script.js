...
MinecraftAPI.getServerStatus(document.getElementById('server-ip').innerHTML, { port: 25572 }, (error, status) => {
    if (error) {
        return document.getElementById('server-status').innerHTML = 'play.powerlandnet.ga';
    }
